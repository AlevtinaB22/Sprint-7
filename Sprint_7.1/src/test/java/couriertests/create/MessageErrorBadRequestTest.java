...
public class MessageErrorBadRequestTest {
    private CourierMetods courierMetods = new CourierMetods();
    ...
    private final String textError = "Недостаточно данных для создания учетной записи";
    ...
    @Description("status code 400, textError = \"Недостаточно данных для создания учетной записи\"")
    public void statusCode400WithoutAllParameters() {
        courierMetods
                .createCourier(null, null, null)
